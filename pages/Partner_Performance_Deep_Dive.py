...
with tab_perf:
    ...
    with col2:
        ...
        st.markdown("- **Why (Actionability):** This provides objective, visual evidence to 'hold partners accountable'. A distribution heavily skewed to the right of the SLA line is clear justification for escalating performance issues.")
